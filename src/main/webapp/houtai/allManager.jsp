	...
	<div class="container">
		...
		<div class="row">
			...
			<%-- 	<a class="btn btn-primary" href="${path}/manager/editManager">新增</a> --%>
				<a class="btn btn-primary" onclick="showAddMask('true')">新增</a>	&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary"href="${path}/manager/index">返回首页</a>
			</div>
		</div>
		<!-- 表格  -->
		<div class="row">
				...
				<table class="table table-hover">
					...
					<c:forEach items="${pageInfo.list }" var="manager">
						<tr>
							...
							<td>
			<%-- 					                <a type="button"  href="${path}/manager/getManager?mid=${manager.mid}" class="btn btn-info btn-sm">
	...
	<div class="modifyMask" align="center">
		<div class="c" align="center">
			...
			<form id="editForm" action="../manager/editManager" method="post"
				...
				&nbsp;&nbsp;密&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="text"
					id="editPassword" name="editPassword" style="width:120px" /> <br />
				<br>

...
.STYLE3 {color: #FFFFFF; font-size: xx-large; }
.STYLE6 {color: #000000}
	...
	<div class="zerogrid">
		<div class="row">
			...
			<div class="col06 offset05">
			   <div id='search-box'>
				  <form action='searchByTitle' method='post' name="search-form" target='_top' id='search-form'>
...
<!--------------Content--------------->
    ...
    <table width="70%">
		<tr align="center"><td><div class="STYLE3 STYLE6" id="titl">${sessionScope.newsxinxi.title }</div></td>
	  </tr>
        <tr align="center"><td><div class="STYLE6" id="zuozheshijian">${sessionScope.newsxinxi.author } <fmt:formatDate value="${sessionScope.newsxinxi.ntime }" pattern="yyyy-MM-dd" /></div></td>
      </tr>
        <tr>
          <td><div align="left" class="STYLE6" id="neirong">
          &nbsp;&nbsp;&nbsp;
          ...
          <c:if test="${z.nid==sessionScope.newsxinxi.nid }"><div align="center" >
						<img src="${z.src }" id="tu${suoyin2.index+1 }"  /><br></div></c:if></c:forEach></c:if></div></td>
      </tr>
       </table>
 <c:if test="${sessionScope.newsxinxi.isreview==1 }">
  ...
  <c:forEach items="${sessionScope.reviewlist }" var="i" varStatus="suoyin1">
    <tr><td><span class="STYLE6">${i.uname }</span></td>
    <td><span class="STYLE6">${i.rtext }</span></td>
    <td><span class="STYLE6"><fmt:formatDate value="${i.rtime }" pattern="yyyy-MM-dd" /></span></td>
  </tr></c:forEach></div>
</table><br>
     <div align="center" >
...
<tr><td><span class="STYLE6" style="font-size: 19px;">其他新闻</span></td>
</tr>
<c:forEach items="${sessionScope.tuijie }" var="i" varStatus="suoyin1" end="3">
<tr><td><a href="xinwenchushihua?flag=${i.nid}" class="STYLE6" style="color: blue">${i.title}</a>
  </tr></c:forEach></div>
</table>

...
.copyright{
display:inline-block; width:100%; text-align: center; background:#201A1A;padding:8px 0px;color:#ffffff;
}
</style>
</head>
<body>
	...
	<%
		User loginUser = (User) request.getSession().getAttribute(
				"loginUser");
		if (loginUser == null) {
	%> <a href="login.jsp" style="float:right;margin-right: 50px"><font
		color="#FFFFFF">用户登录|注册</font>
	</a> <%
 	} else {
 %> <a href="loginout" style="float:right;margin-right: 80px"><font
		color="#FFFFFF">注销</font>
	</a> <a style="float:right;margin-right: 80px"><a href="modifyUserInfo.jsp" style="color: white;float:right;">欢迎 ${loginUser.uname
			} 登录!&nbsp;&nbsp;</a>
	</a> <%
 	}
 %> </header>
				...
				<div class="featured col16">
					<div class="rslides_container">
						<ul class="rslides" id="slider">
							<li><a href="xinwenchushihua?flag=22"><img  src="images/war.jpg" /></a>
							</li>
							<!-- 对应新闻id   22 -->
							<li><a href="xinwenchushihua?flag=39"><img src="images/James.jpg" /></a>
							</li>
							<!-- 对应新闻id   39 -->
							<li><a href="xinwenchushihua?flag=48"><img src="images/ofo.jpg" /></a>
							</li>
							<!-- 对应新闻id   48 -->
							<li><a href="xinwenchushihua?flag=42"><img src="images/liyanhong.jpg" /></a>
							</li>
							<!-- 对应新闻id   42 -->
						</ul>
					</div>
				...
				<div class="main-content col11">
					<c:forEach items="${sessionScope.newshotlist1}" var="p"
						...
						<c:if test="${z.nid==p.nid }">
							<img src="${z.src }" id="tu${suoyin2.index+1 }" width="70 px" style="border:1px;" /></c:if></c:forEach>
	...
	<!--------------Footer--------------->
	<footer>
<div align="center">友情赞助:
<c:forEach items="${sessionScope.zanzhushang }" var="i" varStatus="suoyin1" end="9">
				&nbsp;&nbsp;${i.sname }&nbsp;&nbsp;
		</c:forEach>
